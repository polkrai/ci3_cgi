        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    <li class="<?php echo (uri_string() == '') ? 'active' : ''; ?>"><a href="<?php echo site_url(); ?>"><?php echo 'หน้าแรก'; ?></a></li>
                    <li class="<?php echo (uri_string() == 'contact') ? 'active' : ''; ?>"><a href="<?php echo site_url('contact'); ?>"><?php echo 'ติดต่อ'; ?></a></li>
                    <?php if ($this->session->userdata('logged_in')) : ?>
                        <li class="<?php echo (uri_string() == 'profile') ? 'active' : ''; ?>"><a href="<?php echo site_url('profile'); ?>"><?php echo 'ข้อมูลส่วนตัว'; ?></a></li>
                    <?php endif; ?>
                </ul>
                <?php // Nav bar right ?>
                <ul class="nav navbar-nav navbar-right">
                    <?php if ($this->session->userdata('logged_in')) : ?>
                        <?php if ($this->user['is_admin']) : ?>
                            <li>
                                <a href="<?php echo site_url('admin'); ?>"><?php echo 'ผู้ดูแลระบบ'; ?></a>
                            </li>
                        <?php endif; ?>
                        <li>
                            <a href="<?php echo site_url('logout'); ?>"><?php echo 'ออกจากระบบ'; ?></a>
                        </li>
                    <?php else : ?>
                        <li class="<?php echo (uri_string() == 'login') ? 'active' : ''; ?>">
                            <a href="<?php echo site_url('login'); ?>"><?php echo 'เข้าสู่ระบบ'; ?></a>
                        </li>
                    <?php endif; ?>
                    <li>
                        <span class="dropdown">
