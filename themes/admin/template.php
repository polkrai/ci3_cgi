                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown<?php echo (strstr(uri_string(), 'admin/users')) ? ' active' : ''; ?>">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo (uri_string() == 'admin/users') ? 'active' : ''; ?>"><a href="<?php echo site_url('admin/users'); ?>"><?php echo lang('admin button users_list'); ?></a></li>
                            <li class="<?php echo (uri_string() == 'admin/users/add') ? 'active' : ''; ?>"><a href="<?php echo site_url('admin/users/add'); ?>"><?php echo lang('admin button users_add'); ?></a></li>
                        </ul>
                    </li>
                    <li class="<?php echo (uri_string() == 'admin/contact') ? 'active' : ''; ?>"><a href="<?php echo site_url('admin/contact'); ?>"><?php echo lang('admin button messages'); ?></a></li>
                    <li class="<?php echo (uri_string() == 'admin/settings') ? 'active' : ''; ?>"><a href="<?php echo site_url('admin/settings'); ?>"><?php echo lang('admin button settings'); ?></a></li>
                </ul>
                <?php // Nav bar right ?>
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo site_url('logout'); ?>"><?php echo lang('core button logout'); ?></a></li>
                    <li>
                        <span class="dropdown">
