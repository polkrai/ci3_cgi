...
class Mdl_Appointment extends Response_Model {
	...
	public function default_join()
    {
		...
		$this->db->join('(SELECT max(id) AS max_id FROM frontmed.neural_appointment GROUP BY user_id, visit_id) AS max_appointment_id', 'max_appointment_id.max_id = neural_appointment.id');
    }
