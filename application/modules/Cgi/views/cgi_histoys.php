			...
			<td>
				<div class="options btn-group">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="<?php echo site_url("Cgi/deletes/{$histoy->id}?vn_id={$histoy->vn_id}&hn={$histoy->hn}"); ?>" onclick="return confirm('คุณต้องการลบลบประวัติการประเมิณ  นี้ใช่หรือไม่?');" ><i class="fa fa-trash-o fa-margin"></i> ลบ</a></li>
					</ul>
				</div>
			</td>
		</tr>
