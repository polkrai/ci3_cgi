		...
		<form method="post" id="form-cgi" action="<?php echo current_full_url()?>" style="width:80%;" >
			...
			<div class="form-group">
				...
				<div class="input-group" id="datetimepicker" style="width: 220px;">
					<input type='text' class="form-control" id="created_date" name="created_date" value="<?php echo ($this->mdl_cgi->form_value('created_date'))?$this->mdl_cgi->form_value('created_date'):date('Y-m-d')?>" required />
