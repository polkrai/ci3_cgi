...
<<<<<<< HEAD
    ...
    public function filter_select($txtsearch)
    {
        $findme = ' ';
		$pos 	= strpos($txtsearch, $findme);
        
        if ($pos === FALSE) {
        	
        	$this->filter_or_where('medrec.nano_patient.hn', $txtsearch);
        	
        	$this->filter_or_where('medrec.nano_patient.pa_name', $txtsearch);
		}
		else {
