...
class Mdl_Sessions extends MY_Model {
    ...
    {
    	$this->db->select('nano_session.session_user_id, nano_session.id_sess, nano_user.title_43_file, nano_user.name, nano_user.lastname, nano_user.group_id, nano_user.department_id, neural_user_group.name AS group_name');
    ...
    public function auth_check_session($user_id) {
	    ...
	    $this->db->where('session.id_sess', $this->input->get_post('id_sess')); 
